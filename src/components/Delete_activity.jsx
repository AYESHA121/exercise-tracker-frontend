...
export default function Delete_activity(props) {
  ...
  const { deleteBg,confirmBtn, confirmationText, confirmBtnhover, cancelBtn } = DeleteActivity;
  ...
  const deleteExcerise = async () => {
    const requestPath = `https://exercise-tracker.herokuapp.com/api/exercise/deleteexercise/${deleteId}`;
