...
export default function Editactivity() {
    ...
    const {name, description, activity, duration} = item;
    ...
    const {activityDescription, activityName, activityTime, activityType } = aactivity;
    ...
    const editActivity = (e) => {
        ...
        fetch(`https://exercise-tracker.herokuapp.com/api/exercise/updateexercise/${id}`, {
            method: 'PUT',
            headers: {
